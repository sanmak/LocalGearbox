...
import { validateXML } from '@/lib/tools';
      ...
      <div className="px-4 py-3 border-b border-border/30">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <h1 className="text-xl font-medium text-text-primary">XML Validator</h1>
            <span className="text-sm text-text-tertiary">
              Validate XML syntax and structure instantly
            </span>
          </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <span className="text-xs text-text-secondary font-medium">
              {loading ? 'Validating...' : input ? 'Ready' : 'Enter XML to validate'}
            </span>
          </div>
          {error && (
...
<root>
  ...
  <age>30</age>
        ...
        <div className="flex-1 flex flex-col min-h-0">
          <div className="px-4 py-2 border-b border-border/30 bg-surface-secondary/10">
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-text-secondary">Validation Result</span>
